...
MAX_CAPITAL_PER_TRADE = float(os.getenv('MAX_CAPITAL_PER_TRADE', '0.1'))  # Maximum capital allocation per trade

# Profit targets
PROFIT_TARGET_PERCENT = float(os.getenv('PROFIT_TARGET', '3.0'))  # Target profit percentage
DAILY_PROFIT_TARGET_PERCENT = float(os.getenv('DAILY_PROFIT_TARGET', '5.0'))  # Daily profit target
...
PRE_EVENT_DAYS = 3  # Days before an event to consider
POST_EVENT_DAYS = 1  # Days after an event to consider
